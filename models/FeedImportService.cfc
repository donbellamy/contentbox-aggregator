...
component extends="cborm.models.VirtualEntityService" singleton {
	...
	FeedImportService function import( required Feed feed, required Author author, boolean async=false ) {
		...
		if ( arguments.async && !systemUtil.inThread() ) {
			thread action="run" name="import_feed_#arguments.feed.getContentID()#" feed="#arguments.feed#" author="#arguments.author#" {
				importFeed( attributes.feed, attributes.author  );
			}
		} else {
			importFeed( arguments.feed, arguments.author );
		}
/*
		try {
...
*/
	...
	private boolean function importFeed( required Feed feed, required Author author  ) {
