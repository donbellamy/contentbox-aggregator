...
(`stopDate`),
  KEY `idx_startDate`
(`startDate`),
  CONSTRAINT `FK21AE757E963225F1` FOREIGN KEY
(`contentID`) REFERENCES `cb_content`
(`contentID`)
...
(11) NOT NULL,
  PRIMARY KEY
(`feedImportID`),
  KEY `FKA2F552A382151A90`
(`FK_feedID`),
  KEY `FKA2F552A3AA6AC0EA`
(`FK_authorID`),
  KEY `idx_importFailed`
(`importFailed`),
  KEY `idx_createdDate`
(`createdDate`),
  KEY `idx_modifiedDate`
(`modifiedDate`) /*!80000 INVISIBLE */,
  KEY `idx_deleted`
(`isDeleted`),
  KEY `idx_createDate`
(`createdDate`),
  CONSTRAINT `FKA2F552A382151A90` FOREIGN KEY
(`FK_feedID`) REFERENCES `cb_content`
(`contentID`),
...
(510) NOT NULL,
  ...
  PRIMARY KEY
(`contentID`),
  KEY `FK128D01911ABA7EA4`
(`contentID`),
  KEY `idx_uniqueId`
(`uniqueId`),
  CONSTRAINT `FK128D01911ABA7EA4` FOREIGN KEY
(`contentID`) REFERENCES `cb_content`
(`contentID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(11) NOT NULL,
  PRIMARY KEY
(`feedItemAttachmentID`),
  KEY `FKCB805974E7194996`
(`FK_feedItemID`),
  KEY `idx_createDate`
(`createdDate`),
  KEY `idx_modifiedDate`
