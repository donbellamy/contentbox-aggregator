...
<div class="btn-group btn-group-xs">
	...
	<ul class="dropdown-menu">
		...
		<li><a href="#event.buildLink(prc.xehFeedItemEntry)#/contentID/#prc.feedItem.getContentID()#"><i class="fa fa-copy"></i> Save as Entry</a></li>
	</ul>
</div>
#html.startForm(
				...
				<div role="tabpanel" class="tab-pane active" id="editor">
					...
					<div class="form-group">
						<label for="slug" class="control-label">
							...
							<small>#prc.agHelper.linkFeedItems()#/</small>
						</label>
						<div class="controls">
						...
						<div id="featuredImagePanel" class="panel-collapse collapse">
							<div class="panel-body">
								<div class="form-group text-center">
									...
									<div class="<cfif !len( prc.feedItem.getFeaturedImageURL( getAltImageUrl=false ) ) >hide</cfif> form-group" id="featuredImageControls">
